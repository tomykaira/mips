...
execute_start:
	...
	# add pc for jump and call
	beq	$r16, $r11, execute_add_pc
	nop
	nop
	beq	$r16, $r12, execute_add_pc
	nop
	nop
	beq	$r16, $r13, execute_add_pc
	nop
	nop
	...
	j	execute_start
execute_add_pc:
	add	$r8, $r8, $r9	# add offset
	program	$r10, $r8
	addi	$r10, $r10, 1
	j	execute_start
execute_end:
	addi	$r3, $r5, 0		# set argument address
	j	invoke_subprocess	# generated by compiler
